      ...
      {loggedIn ? (
        <div>
          <nav>
            <ul>
              <div className='button_container'>
                <li><button className='reservation' onClick={() => handleNavigation('Reservation')}> CUSTOMER ORDERS </button></li>
                <li><button className='customers' onClick={() => handleNavigation('Orders')}>CUSTOMERS ORDER INFORMATION</button></li>
